...
JSONEditor.defaults.editors.search = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    this.input = this.theme.getSelectInput(this.input_type);
    ...
    if(window.jQuery && window.jQuery.fn && window.jQuery.fn.selectize ) {
      ...
      this.selectize = window.jQuery(this.input).selectize($extend(options,
      {
        ...
        load: function(query, callback) {
            ...
            callback(document.item_registry.of_type(subtype));
            $.ajax({
                url: JSONEditor.autocomplete_path+subtype+'?q=' + encodeURIComponent(query),
                type: 'GET',
                error: function() {
                    callback();
                },
                success: function(res) {
                    results = document.item_registry.of_type(subtype).concat(res.results);
                    console.log(results);
                    callback(results);
                }
            });
